...
public class EmailHelper {
	...
	public String buildForgotPasswordContent(int code) {

		StringBuilder sb = new StringBuilder("");

		sb.append(getHeaderHtml()).append("<p>We received a request to <b>reset your KYC password.</b></span>")
				.append("</br></br></br>")
				...
				.append("<p><b>").append(code).append("</b></p> </span>").append("<hr>")
	...
	public String buildUserSignupVerificationEmailContent(Map<String, String> param) {
		...
		sb.append(getHeaderHtml()).append(
				"<p>Welcome to ANX! Before you get started, click the <b>link</b> below to complete your registration</span>")
				.append("</br></br></br>")
				.append("<span style=\"font-family: Arial, Helvetica, sans-serif; font-size:32px; color:#3399cc;\">")
				.append("<p><b>").append("<a href=\"").append(verificationCode).append("\">")
				.append("Confirm my email address").append("</a>").append("</b></p> </span>").append("<hr>")
				.append("<span style=\"font-family: Arial, Helvetica, sans-serif; font-size:11px; color:#757575;\">")
	...
	public String buildChangeEmailVerificationCode(int code) {

		StringBuilder sb = new StringBuilder("");

		sb.append(getHeaderHtml()).append("<p>We received a request to <b>change your E-mail.</b></span>")
				.append("</br></br></br>")
				.append("<span style=\"font-family: Arial, Helvetica, sans-serif; font-size:16px; color:#757575;\">")
				.append("If you made this request, please use the following ")
				.append("<b>Verification Code:</b></p> </span>")
				...
				.append("<p><b>").append(code).append("</b></p> </span>").append("<hr>")
				.append("<span style=\"font-family: Arial, Helvetica, sans-serif; font-size:11px; color:#757575;\">")
				.append("<p>If you didn't request for to change your E-mail, please contact us at <a href=\"#\">help@anx.kyc.com</a></p>")
				.append(getFooterHtml());
