...
<body>
			...
			<form:form id="contact-us" method="POST" modelAttribute="anxUserForm"
				...
				<div id="emailAddressGroupId" style="display:${emailDisplay};">
					...
					<div class="usernameChooserLink">
						<a id="usePhonelinkId" href="#"
							onclick="myFunction();return false;"><spring:message
								code="kyc.account.signup.phone" /> </a>
					</div>
				</div>

				<div id="phoneGroupId" style="display:${phoneDisplay};">
					<form:errors path="phoneNumber" class="formerror" />
					<form:select class="selectpicker phone-code-width"
						data-live-search="true" path="phoneCode.phoneCodeId">
						<form:options items="${countryCodeList}" itemValue="phoneCodeId"
							itemLabel="phoneCodeCountry" />
					</form:select>
					<form:input path="phoneNumber" class="form phone-number-width"
						placeholder="Mobile Number" />
					<div class="usernameChooserLink">
						<a href="#" onclick="myFunction();return false;"><spring:message
								code="kyc.account.signup.email" /> </a>
					</div>
				...
				<form:password path="confirmPassword" required="required"
					class="form" placeholder="Confirm Password" />
				<input type="submit" class="form-btn semibold"
					value="Create Account" formnovalidate />
			</form:form>
			<div class="clear"></div>
	...
	<script>
		...
		function myFunction() {
			...
			var emailAddressGroupId = document
					.getElementById("emailAddressGroupId");
			var phoneGroupId = document.getElementById("phoneGroupId");
			...
			if (emailAddressGroupId.style.display === "none") {
				...
				phoneNumber.value = "";
				document.getElementById("usePhonelinkId").style.display = "block";
			} else {
